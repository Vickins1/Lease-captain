...
var $dark_mode_checkbox = $('<input />', {
  type: 'checkbox',
  value: 1,
  checked: false, // Ensure the checkbox is unchecked by default
  class: 'mr-1'
}).on('click', function () {
  if ($(this).is(':checked')) {
...
// Ensure the body does not have the dark mode class by default
$('body').removeClass('dark-mode');

// Create the container for the dark mode toggle
...
// Ensure the nav-sidebar has the 'nav-flat' class by default
...
var $flat_sidebar_checkbox = $('<input />', {
  type: 'checkbox',
  value: 1,
  checked: true, // Set to true to ensure it's checked
  class: 'mr-1'
}).on('click', function () {
  if ($(this).is(':checked')) {
    $('.nav-sidebar').addClass('nav-flat');
...
// Create the container and append the checkbox and label
...
$container.append($flat_sidebar_container);
  ...
  var $compact_sidebar_checkbox = $('<input />', {
    type: 'checkbox',
    value: 1,
    checked: true, // Ensures the checkbox is checked by default
    class: 'mr-1'
  }).on('click', function () {
    if ($(this).is(':checked')) {
  ...
  // Add the 'nav-compact' class to ensure the sidebar is compact by default
  $('.nav-sidebar').addClass('nav-compact')
